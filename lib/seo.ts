...
/** Гео для Москвы, ул. Удальцова 54 */
export const GEO = {
  region: "RU-MOW",
  placename: "Москва",
...
export function getLocalBusinessJsonLd() {
  return {
    ...
    description:
      "Автосервис, автомойка, автоателье, стекла в Москве. Обслуживание электромобилей и гибридов. Ул. Удальцова, 54.",
    url: SITE_URL,
    telephone: "+7-916-000-54-54",
    address: {
      "@type": "PostalAddress",
      streetAddress: "ул. Удальцова, д. 54",
...
export const PAGE_META = {
  home: {
    ...
    description:
      "Т-АВТО (т авто) — автосервис и детейлинг в Москве, Удальцова 54. Ремонт авто, мойка, химчистка, автоателье, стекла. Электромобили и гибриды.",
  ...
  services: {
    ...
    description:
      "Автосервис, автомойка, автоателье, стекла: прайс и описание услуг. Замена масла, химчистка, керамика, перетяжка салона, бронирование стекол. Москва, Удальцова 54.",
    keywords: [
  ...
  about: {
    ...
    description:
      "Профессиональная команда T-AUTO: автосервис, детейлинг, работа с электромобилями и гибридами. Москва, ул. Удальцова, 54.",
    keywords: [
      "T-AUTO о компании",
  ...
  contacts: {
    ...
    description:
      "Автосервис T-AUTO: Москва, ул. Удальцова, 54. Телефон +7 (916) 000-54-54. Режим работы, карта, запись на услуги.",
    keywords: [
      "T-AUTO контакты",
      "автосервис Удальцова 54",
