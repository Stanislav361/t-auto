  ...
  const autoservices: ServiceCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Комплексная диагностика ходовой части", price: "от 3 590 ₽" },
        ...
        { name: "Замена нижних передних рычагов в сборе 1 шт", price: "от 2 500 ₽" },
        { name: "Замена верхних передних рычагов в сборе 1 шт", price: "от 2 200 ₽" },
        { name: "Замена верхних шаровых опор без снятия рычага (на болтах)", price: "от 1 800 ₽" },
        { name: "Замена нижних шаровых опор на болтах", price: "от 1 800 ₽" },
        { name: "Замена нижних шаровых опор с выпрессовкой", price: "от 3 000 ₽" },
        { name: "Замена передних стоек Маккферсон", price: "от 2 800 ₽" },
        { name: "Замена стоек стабилизатора 1 шт", price: "от 850 ₽" },
        { name: "Замена задних пружин 1 шт (в прямом доступе)", price: "от 1 500 ₽" },
      ]
    },
    {
    ...
    },
    {
      ...
      description: "Ремонт суппортов, цилиндров, магистралей, шлангов и датчиков ABS",
      items: [
        { name: "Замена тормозного суппорта с прокачкой", price: "от 1 500 ₽" },
        { name: "Ремонт тормозного переднего суппорта при замене колодок однопоршневой", price: "от 2 200 ₽" },
        { name: "Замена рем. комплекта поршня при снятом суппорте 1 шт", price: "от 800 ₽" },
        { name: "Ремонт тормозного заднего суппорта винтового", price: "от 2 600 ₽" },
        { name: "Замена рабочего тормозного цилиндра", price: "от 2 700 ₽" },
        { name: "Замена рабочего заднего тормозного цилиндра при снятых тормозных колодках", price: "от 800 ₽" },
        { name: "Замена троса\\тросов стояночного тормоза с регулировкой 1 шт", price: "от 1 500 ₽" },
        { name: "Замена тормозной трубки (магистральной) 1 контур без доп работ", price: "от 5 000 ₽" },
        { name: "Замена тормозного шланга", price: "от 1 200 ₽" },
        { name: "Демонтаж направляющих тормозного суппорта с доп работами 1шт", price: "от 300 ₽" },
        { name: "Замена главного тормозного цилиндра", price: "от 3 800 ₽" },
        { name: "Замена датчиков АБС", price: "от 1 200 ₽" },
      ]
    },
    {
      icon: <Wrench className="h-7 w-7" />,
      title: "Ремонт системы выпуска",
      description: "Глушитель, катализатор, гофра, датчики и элементы выхлопной системы",
      items: [
        { name: "Снять установить глушитель", price: "от 2 800 ₽" },
        { name: "Снять установить элемент глушителя (средняя часть)", price: "от 1 800 ₽" },
        { name: "Снять установить элемент глушителя (задняя часть)", price: "от 1 800 ₽" },
        { name: "Замена прокладки приемной трубы глушителя (в зависимости от доступа)", price: "от 2 300 ₽" },
        { name: "Замена кислородных датчиков в прямом доступе", price: "от 1 500 ₽" },
        { name: "Замена кислородных датчиков с доп работами", price: "от 2 000 ₽" },
        { name: "Замена выпускных коллекторов", price: "от 6 100 ₽" },
        { name: "Замена гофры", price: "от 3 500 ₽" },
        { name: "Замена соединительного хомута (VAG)", price: "от 800 ₽" },
        { name: "Удаление катализатора со снятием", price: "от 5 500 ₽" },
        { name: "Удаление катализатора без снятия", price: "от 2 000 ₽" },
        { name: "Ремонт крепления глушителя", price: "от 1 200 ₽" },
        { name: "Слесарные работы при демонтаже", price: "от 500 ₽" },
        { name: "Восстановление резьбы соединения приемной трубы 1 крепление", price: "от 800 ₽" },
      ]
    },
    {
      icon: <Wrench className="h-7 w-7" />,
      title: "Ремонт двигателя",
      description: "ГРМ, свечи, прокладки, подушки двигателя и сопутствующие работы",
      items: [
        { name: "Замена ремня навесных агрегатов", price: "от 1 800 ₽" },
        { name: "Замена ролика натяжителя ремня навесных агрегатов при снятом ремне", price: "от 500 ₽" },
        { name: "Замена механизма натяжения приводного ремня при снятом ремне", price: "от 800 ₽" },
        { name: "Замена комплекта ГРМ на ДВС с одним распределительным валом", price: "от 7 500 ₽" },
        { name: "Замена комплекта ГРМ на ДВС с двумя распределительными валами (4-6)", price: "от 8 500 ₽" },
        { name: "Замена помпы при снятом ГРМ", price: "от 1 700 ₽" },
        { name: "Замена сальников при снятом ремне ГРМ 1 шт", price: "от 900 ₽" },
        { name: "Замена сальника коленвала (переднего) ГРМ цепь", price: "от 3 100 ₽" },
        { name: "Замена свечей в прямом доступе без снятия коллектора", price: "от 250 ₽" },
        { name: "Замена высоковольтных проводов при замене свечей", price: "от 200 ₽" },
        { name: "С/У впускного коллектора", price: "от 4 500 ₽" },
        { name: "Замена свечей при снятом впускном коллекторе 1 шт", price: "от 250 ₽" },
        { name: "Замена катушек зажигания 1 шт (без снятия коллектора)", price: "от 250 ₽" },
        { name: "Замена прокладки клапанной крышки", price: "от 2 000 ₽" },
        { name: "Замена прокладки клапанной крышки при снятом коллекторе", price: "от 1 900 ₽" },
        { name: "Замена подушек двигателя 1 шт", price: "от 1 500 ₽" },
        { name: "Замена прокладки поддона без с/у приемной трубы", price: "от 2 000 ₽" },
        { name: "Замена прокладки поддона со снятием приемной трубы", price: "от 3 200 ₽" },
        { name: "Замена прокладки ГБЦ 4-6", price: "от 28 000 ₽" },
        { name: "Замена маслосъемных колпачков (без снятия ГБЦ)", price: "от 20 000 ₽" },
      ]
    },
    {
      icon: <Snowflake className="h-7 w-7" />,
      title: "Ремонт системы охлаждения и кондиционирования",
      description: "Радиаторы, термостаты, патрубки, кондиционер и система охлаждения",
      items: [
        { name: "С/У радиатор охлаждения без с/у бампера", price: "от 4 000 ₽" },
        { name: "С/У радиатора охлаждения АКПП при снятом бампере", price: "от 1 500 ₽" },
        { name: "С/У радиатор кондиционера при снятом бампере без откачки фреона", price: "от 1 500 ₽" },
        { name: "Замена радиатора отопителя без снятия приборной панели", price: "от 8 150 ₽" },
        { name: "С/У муфты кондиционера без демонтажа компрессора", price: "от 3 850 ₽" },
        { name: "Промывка радиатора системы охлаждения при снятом с химией liqui moly", price: "от 1 500 ₽" },
        { name: "Замена патрубков при замене антифриза", price: "от 800 ₽" },
        { name: "Замена термостата", price: "от 2 100 ₽" },
        { name: "Замена термостата с корпусом распределителя (пластик)", price: "от 3 800 ₽" },
        { name: "Замена вентилятора охлаждения", price: "от 2 200 ₽" },
        { name: "Замена внешней помпы", price: "от 3 650 ₽" },
        { name: "Опрессовка системы охлаждения (поиск утечек)", price: "от 1 000 ₽" },
        { name: "Замена расширительного бачка без замены ох.ж.", price: "от 800 ₽" },
        { name: "Заправка климатической установки", price: "от 2 000 ₽" },
        { name: "Антибактериальная обработка системы конд с заменой фильтра AC", price: "от 1 200 ₽" },
        { name: "Замена прокладки теплообменника", price: "от 6 800 ₽" },
      ]
    },
    {
      icon: <Zap className="h-7 w-7" />,
      title: "Ремонт электрики",
      description: "Стартер, генератор, датчики, освещение и электрические узлы",
      items: [
        { name: "Снятие/ установка и ремонт трапеции дворников", price: "от 2 000 ₽" },
        { name: "Замена ламп 1 шт (галоген)", price: "от 350 ₽" },
        { name: "Замена ламп 1шт (со снятием фары/обшивки)", price: "от 500 ₽" },
        { name: "Замена ламп 1шт (ксенон)", price: "от 500 ₽" },
        { name: "Замена стартера", price: "от 4 200 ₽" },
        { name: "Замена генератора", price: "от 2 800 ₽" },
        { name: "Замена датчика массового расхода воздуха", price: "от 1 200 ₽" },
        { name: "Адаптация дроссельной заслонки", price: "от 1 200 ₽" },
        { name: "Снятие\\установка АКБ в прямом доступе", price: "от 500 ₽" },
        { name: "Замена датчика 1 шт в доступе", price: "от 1 200 ₽" },
        { name: "Замена датчика 1 шт с доп работами", price: "от 1 800 ₽" },
        { name: "Диагностика электромагнитный муфты AC", price: "от 2 500 ₽" },
        { name: "Диагностика вентилятора сист.охлаждения", price: "от 1 500 ₽" },
        { name: "Диагностика моторчика омывателя лобового/заднего стекла", price: "от 1 000 ₽" },
        { name: "Замена/ремонт разъема", price: "от 1 000 ₽" },
      ]
    },
    {
    ...
    {
      icon: <Wrench className="h-7 w-7" />,
      title: "Ремонт сцепления",
      description: "Замена и обслуживание сцепления, цилиндров и сопутствующих узлов",
      items: [
        { name: "Замена сцепления в сборе без с/у подрамника", price: "от 9 500 ₽" },
        { name: "Замена сцепления в сборе со снятием / демонтажем подрамника", price: "от 14 500 ₽" },
        { name: "Замена рабочего цилиндра сцепления", price: "от 2 800 ₽" },
        { name: "Замена главного цилиндра сцепления", price: "от 3 100 ₽" },
        { name: "Замена жидкости сцепления", price: "от 900 ₽" },
        { name: "Замена заднего сальника к/в при снятом маховике", price: "от 1 000 ₽" },
        { name: "С/у маховика при снятой коробке, диске сцепления, корзине сцепления", price: "от 1 200 ₽" },
        { name: "Замена троса сцепления", price: "от 3 800 ₽" },
      ]
    },
    {
      icon: <Search className="h-7 w-7" />,
      title: "Диагностика",
      description: "Компьютерная диагностика и устранение ошибок",
      items: [
